...
import com.degtu.myesalon.databinding.ActivityViewAllCleanUpBinding;
...
public class ViewAllCleanUpActivity extends AppCompatActivity {

    ActivityViewAllCleanUpBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityViewAllCleanUpBinding.inflate(getLayoutInflater());
        ...
        firebaseFirestore.collection("salon").whereEqualTo("service","Clean Up").addSnapshotListener(new EventListener<QuerySnapshot>() {
