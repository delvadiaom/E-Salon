...
import com.degtu.myesalon.databinding.ActivityViewAllUnisexSalonBinding;
...
public class ViewAllUnisexSalonActivity extends AppCompatActivity {

    ActivityViewAllUnisexSalonBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityViewAllUnisexSalonBinding.inflate(getLayoutInflater());
        ...
        binding.unisexsalons.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        binding.unisexsalons.setAdapter(detailManSalonAdapter);
