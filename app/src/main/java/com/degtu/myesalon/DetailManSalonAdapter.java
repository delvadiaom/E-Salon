...
public class DetailManSalonAdapter extends RecyclerView.Adapter<DetailManSalonAdapter.SalonViewHolder> {

    private final Context context;
    private final ArrayList<Salon> salonArrayList;

    public DetailManSalonAdapter(Context context, ArrayList<Salon> salonArrayList) {
    ...
    public SalonViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_salon_detail,parent,false);
    ...
    public void onBindViewHolder(@NonNull SalonViewHolder holder, int position) {
        ...
        holder.binding.specialservicetxt.setText(salon.getService());
    ...
    public static class SalonViewHolder extends RecyclerView.ViewHolder{
        ...
        RowSalonDetailBinding binding;

        public SalonViewHolder(@NonNull View itemView) {
            super(itemView);

            binding = RowSalonDetailBinding.bind(itemView);
        }
    }
}
