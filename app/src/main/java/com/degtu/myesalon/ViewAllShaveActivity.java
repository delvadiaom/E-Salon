...
import com.degtu.myesalon.databinding.ActivityViewAllShaveBinding;
...
public class ViewAllShaveActivity extends AppCompatActivity {

    ActivityViewAllShaveBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityViewAllShaveBinding.inflate(getLayoutInflater());
        ...
        firebaseFirestore.collection("salon").whereEqualTo("service","Shave").addSnapshotListener(new EventListener<QuerySnapshot>() {
